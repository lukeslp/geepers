...
SKILL_MAP = {
    ...
    "conductor": {
        "type": "standalone",
        "files": ["geepers_conductor.md"],
    },
    "checkpoint": {
        "type": "orchestrator",
        "orchestrator": "geepers_orchestrator_checkpoint.md",
        "agents": [
            "geepers_scout.md",
            "geepers_repo.md",
            "geepers_status.md",
    ...
    "corpus": {
        "type": "orchestrator",
        "orchestrator": "geepers_orchestrator_corpus.md",
        "agents": [
            "geepers_corpus.md",
            "geepers_corpus_ux.md",
        ],
    },
    "deploy": {
        "type": "orchestrator",
        "orchestrator": "geepers_orchestrator_deploy.md",
        "agents": [
            "geepers_caddy.md",
            "geepers_services.md",
            "geepers_validator.md",
        ],
    },
    "frontend": {
        "type": "orchestrator",
        "orchestrator": "geepers_orchestrator_frontend.md",
        "agents": [
            "geepers_css.md",
            "geepers_design.md",
            "geepers_motion.md",
            "geepers_typescript.md",
            "geepers_uxpert.md",
            "geepers_webperf.md",
        ],
    },
    "fullstack": {
        "type": "orchestrator",
        "orchestrator": "geepers_orchestrator_fullstack.md",
        "agents": [
            "geepers_db.md",
            "geepers_react.md",
        ],
    ...
    "games": {
        "type": "orchestrator",
        "orchestrator": "geepers_orchestrator_games.md",
        "agents": [
            "geepers_game.md",
            "geepers_gamedev.md",
            "geepers_godot.md",
    ...
    "hive": {
        "type": "orchestrator",
        "orchestrator": "geepers_orchestrator_hive.md",
        "agents": [
            "geepers_builder.md",
            "geepers_integrator.md",
            "geepers_planner.md",
            "geepers_quickwin.md",
            "geepers_refactor.md",
        ],
    ...
    "python-dev": {
        "type": "orchestrator",
        "orchestrator": "geepers_orchestrator_python.md",
        "agents": [
            "geepers_pycli.md",
        ],
    },
    "quality": {
        "type": "orchestrator",
        "orchestrator": "geepers_orchestrator_quality.md",
        "agents": [
            "geepers_a11y.md",
            "geepers_critic.md",
            "geepers_deps.md",
    ...
    "research": {
        "type": "orchestrator",
        "orchestrator": "geepers_orchestrator_research.md",
        "agents": [
            "geepers_citations.md",
            "geepers_data.md",
            "geepers_diag.md",
            "geepers_fetcher.md",
            "geepers_links.md",
    ...
    "web-dev": {
        "type": "orchestrator",
        "orchestrator": "geepers_orchestrator_web.md",
        "agents": [
            "geepers_express.md",
            "geepers_flask.md",
        ],
    ...
    "api-design": {
        "type": "standalone",
        "files": ["geepers_api.md"],
    },
    "canary": {
        "type": "standalone",
        "files": ["geepers_canary.md"],
    },
    "dashboard": {
        "type": "standalone",
        "files": ["geepers_dashboard.md"],
    },
    "docs": {
        "type": "standalone",
        "files": ["geepers_docs.md"],
    },
    "git-ops": {
        "type": "standalone",
        "files": ["geepers_git.md"],
    },
    "janitor": {
        "type": "standalone",
        "files": ["geepers_janitor.md"],
    },
    "scalpel": {
        "type": "standalone",
        "files": ["geepers_scalpel.md"],
    },
    "todoist": {
        "type": "standalone",
        "files": ["geepers_todoist.md"],
    },
    "humanize": {
        "type": "standalone",
        "files": ["geepers_humanizer.md"],
    },
    # === SYSTEM AGENTS ===
    "system-diag": {
        "type": "standalone",
        "files": ["geepers_system_diag.md"],
    },
    "system-help": {
        "type": "standalone",
        "files": ["geepers_system_help.md"],
    },
    "system-onboard": {
        "type": "standalone",
        "files": ["geepers_system_onboard.md"],
    },
    # === DATAVIS AGENTS ===
    "datavis-agents": {
        "type": "orchestrator",
        "orchestrator": "geepers_orchestrator_datavis.md",
        "agents": [
            "geepers_datavis_color.md",
            "geepers_datavis_data.md",
            "geepers_datavis_math.md",
            "geepers_datavis_story.md",
            "geepers_datavis_viz.md",
        ],
    },
}
